    ...
    <div style={{ maxWidth: 900, margin: '32px auto', background: '#fff', borderRadius: 12, padding: 32 }}>
      ...
      <Card bordered={false} style={{ marginBottom: 24 }}>
        <Typography.Paragraph>
          <b>Hướng dẫn tra cứu lịch thi:</b> Thí sinh nên thường xuyên kiểm tra lịch thi trên website chính thức và tài khoản cá nhân để cập nhật các thay đổi mới nhất về thời gian, địa điểm thi.
        </Typography.Paragraph>
        <Typography.Paragraph>

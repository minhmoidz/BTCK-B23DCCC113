...
const AdmissionManagement: React.FC = () => {
  ...
  const fetchSchools = async () => {
    try {
      const response = await fetch('https://btck-123.onrender.com/api/truong', {
        headers: {
  ...
  const fetchMajors = async (schoolId: string) => {
    try {
      const response = await fetch(`https://btck-123.onrender.com/api/nganh/${schoolId}`, {
        headers: {
          'Content-Type': 'application/json'
        }
      });
  ...
  const fetchQuotas = async (schoolId: string, majorId: string, academicYear: number) => {
    try {
      ...
      const response = await fetch(
        `https://btck-123.onrender.com/api/admin/admission-quotas?schoolId=${schoolId}&majorId=${majorId}&academicYear=${academicYear}`,
        {
          headers: {
            'Content-Type': 'application/json'
          }
  ...
  const executeAdmissionProcess = async (values: any) => {
    try {
      ...
      const response = await fetch('https://btck-123.onrender.com/api/admin/process-admission-complete', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleSaveQuota = async () => {
    try {
      ...
      const response = await fetch('https://btck-123.onrender.com/api/admin/admission-quotas', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
